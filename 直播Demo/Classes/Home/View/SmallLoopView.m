...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (!titleLabel) {
        titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, cell.bounds.size.width, cell.bounds.size.width, 20)];
        titleLabel.tag = 2;
    ...
    titleLabel.text = room.nick;
    
    [iv sd_setImageWithURL:room.avatar placeholderImage:LGLoadingImage];
    return cell;
