...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (!titleLabel) {
        titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(10, self.bounds.size.height - 20, self.bounds.size.width - 120, 20)];
        titleLabel.tag = 2;
    ...
    [iv sd_setImageWithURL:room.thumb placeholderImage:LGLoadingImage];
